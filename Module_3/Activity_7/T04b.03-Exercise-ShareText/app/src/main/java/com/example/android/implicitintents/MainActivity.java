...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String shareText = "Sharing the coolest thing I've learned so far. You should" + "\n" +
    ...
    void shareText(String inputtext) {
        String mimeType = "text/plain";
        String title = "Learnig How to Share";
        ShareCompat.IntentBuilder.from(this).setType(mimeType).setChooserTitle(title).setText(inputtext).startChooser();
    }
